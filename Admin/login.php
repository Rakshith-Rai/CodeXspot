...
<head>
  ...
  <title>Codexspot Admin login</title>
  <!-- plugins:css -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="controller/login.php" method="POST" >
                ...
                <div class="mt-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="index.html" type="submit" name="login">SIGN IN</button>
                </div>
