            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action='controller/uploadvideo.php' method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                  <input type="text" value="<?php echo $ro['c_name'] ?>"  name="c_id" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required >
                  <input type="hidden" value="<?php echo $ro['c_id'] ?>"  name="c_id" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required >
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input type="text" class="form-control file-upload-info" required disabled placeholder="Upload Video">
                    ...
                    <a href="view_uploaded_vedio.php" class="btn btn-light">View Uploaded Video</a>
                  </form>
                </div>
              </div>
            </div>
